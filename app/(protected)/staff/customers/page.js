...
export default function StaffCustomersPage() {
    ...
    const handleAddCustomer = async (e) => {
        ...
        try {
            const customerData = {
                ...newCustomer,
                customerType: 'regular', // Staff chỉ có thể tạo khách hàng thường
                isVip: false
            };
        ...
        try {
            const response = await fetch('http://localhost:5001/api/customers', {
                ...
                body: JSON.stringify({
                    id: editCustomer.id,
                    ...newCustomer,
                    // Giữ nguyên các trường staff không được phép thay đổi
                    cccd: editCustomer.cccd,
                    customerType: editCustomer.customerType,
                    isVip: editCustomer.isVip
                }),
            });
    ...
    const handleSearch = async () => {
        try {
            ...
            const filteredCustomers = data.filter(customer =>
                ...
                (customer.licensePlate && customer.licensePlate.includes(searchTerm))
            );
            ...
            <div className="min-h-screen bg-gray-100 p-6">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex space-x-4 mb-6">
                        <Link href="/staff/vehicles" className="px-4 py-2 rounded-md bg-gray-200 text-gray-700 transition-all duration-300 ease-in-out transform hover:scale-105 hover:bg-blue-600 hover:text-white hover:shadow-lg">
                            Quản lý xe
                        </Link>

                        <Link href="/staff/customers" className="px-4 py-2 rounded-md bg-blue-500 text-white transition-all duration-300 ease-in-out transform hover:scale-105 hover:bg-blue-600 hover:shadow-lg">
                            Quản lý khách hàng
                        </Link>
                    </div>

                    <div className="bg-white p-6 rounded-lg shadow-md mb-6">
                        <h2 className="text-xl font-semibold text-gray-700 mb-4">Đăng ký khách hàng mới</h2>
                        <Button
                        ...
                        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                            <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-2xl max-h-[70vh] overflow-y-auto">
                                <h2 className="text-2xl font-semibold text-gray-700 mb-6">
                                    {editCustomer ? 'Sửa thông tin khách hàng' : 'Đăng ký khách hàng mới'}
                                </h2>
                                ...
                                <form onSubmit={editCustomer ? handleEditCustomer : handleAddCustomer} className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <input
                                                type="text"
                                                value="Nhấn vào icon để cập nhật thông tin xe"
                                                readOnly
                                    ...
                                    {editCustomer && (
                                        <div className="bg-gray-100 p-4 rounded-md">
                                            <h3 className="font-medium text-gray-700 mb-2">Thông tin bổ sung (chỉ admin có thể thay đổi)</h3>
                                            <div className="grid grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                    <label className="block text-gray-600 mb-1">Loại khách hàng:</label>
                                                    <input
                                                        type="text"
                                                        value={editCustomer.isVip ? 'VIP' : 'Thường'}
                                                        className="w-full p-2 border rounded-md bg-gray-200"
                                                        disabled
                                                    />
                                                </div>
